...
function USMap(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 959 593" className="mt-3 mb-5">
      <defs>
        <style type="text/css">
          {`
          .state { fill:#D3D3D3; }
          circle { cursor: pointer; }
          circle:hover { stroke: #979BA5; }
          circle.active { stroke: #2C3C4D; fill: #75CCCD; }
        `}
        </style>
      </defs>
...
export default class Weather extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      error: null,
      cities: [
        { name: 'Chicago, IL', gridX: 615, gridY: 210,  latlng: '41.8754,-87.6267' },
        { name: 'Indianapolis, IN', selected: true, gridX: 645, gridY: 255, latlng: '39.7712,-86.1588' },
        { name: 'Los Angeles, CA', gridX: 80, gridY: 350, latlng: '34.0481,-118.2400' },
        { name: 'New York, NY', gridX: 845, gridY: 195, latlng: '40.7212,-73.9974' },
        { name: 'Washington, DC', gridX: 802, gridY: 252, latlng: '38.9015,-77.0454' }
      ]
    }
  ...
  loadWeather(latlng) {
    fetch(`https://api.weather.gov/points/${latlng}/forecast`)
      .then(response => {
        if(response.ok) {
      ...
      .catch(error => { console.log(error); this.setState({error: 'Error loading weather data'})});
  }
