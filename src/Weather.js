...
function USMap(props) {
  ...
  <g id="outlines" className="state">
    ...
    <g id="DC">
      ...
      <circle id="DC2" stroke="#FFF" strokeWidth="1.5" cx="801.3" cy="251.8" r="5"/>
    </g>
    <circle id="CHI" strokeWidth="1.5" cy="210" r="5" cx="615" stroke="#666" onClick={() => props.onClick('Chicago, IL', 'LOT', '74,72')}/>
    <circle id="IND" strokeWidth="1.5" cy="255" r="5" cx="645" stroke="#666" onClick={() => props.onClick('Indianapolis, IN', 'IND', '57,68')}/>
    <circle id="LOX" strokeWidth="1.5" cy="350" r="5" cx="80" stroke="#666" onClick={() => props.onClick('Los Angeles, CA', 'LOX', '156,44')}/>
    <circle id="NYC" strokeWidth="1.5" cy="195" r="5" cx="845" stroke="#666" onClick={() => props.onClick('New York, NY', 'OKX', '32,34')}/>
  </g>
...
export default class Weather extends React.Component {
  constructor(props) {
    ...
    this.loadWeather('IND', '57,68');
  }

  loadWeather(wfo, xy) {
    fetch(`https://api.weather.gov/gridpoints/${wfo}/${xy}/forecast`)
      .then(response => {
        if(response.ok) {
  ...
  locationClicked(locationName, wfo, xy) {
    this.setState({locationName});
    this.loadWeather(wfo, xy);    
  }
